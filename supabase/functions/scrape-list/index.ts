      ...
      formats: [
        {
          ...
          prompt:
            "Extrais TOUS les appels d'offres / consultations publiques visibles sur cette page. Pour chaque consultation, capture le titre, la référence, l'acheteur, la date limite, le type, le montant si présent, et l'URL absolue vers la page détail (résoudre les liens relatifs avec l'URL de base).",
        },
      ],
