      ...
      formats: [
        {
          ...
          prompt:
            "Cette page est un portail de marchés publics français (Atexo, marches-publics.info ColdFusion, ou SDM/Local-trust). Extrais TOUTES les consultations / appels d'offres affichés dans le tableau ou la liste principale. Pour chaque ligne, capture : titre/intitulé/objet, référence (numéro de consultation), nom de l'acheteur, date limite de remise des offres (format texte tel qu'affiché, ex: '15/05/2026 12:00'), date de publication, type de procédure (MAPA, AOO, AOR, etc.), type de contrat (travaux/services/fournitures), lieu/département, et l'URL ABSOLUE vers la page détail de la consultation (résoudre tout lien relatif comme '?page=...&id=...' en utilisant l'URL de base de la page). Ignore les filtres de recherche, la pagination, les en-têtes de colonnes et les bandeaux. Si aucune consultation n'est visible, renvoie un tableau vide.",
        },
      ],
